...
async def list_items(
    ...
    items = await item_service.list_items(skip=skip, limit=limit, available_only=available_only)
    return items
...
async def get_item_count(
    ...
    count = await item_service.get_item_count(available_only=available_only)
    return {"count": count}
